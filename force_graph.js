Rally.createApp('ForceGraph', {

    items:[
        {
            xtype:'container', itemId:'forceGraph'
        },
        {
            xtype:'container', itemId:'details', width:400
        }
    ],

    launch:function () {
        this.down('#forceGraph').add({
            xtype:'component',
            html :'<div id=\"someID\">FORCE GRAPH</div>'
        });

        this.down('#details').add({
            xtype:'component',
            html :'DETAILS'
        });

        this.installForceGraph('someID');
    },

    installForceGraph:function (containerID) {
